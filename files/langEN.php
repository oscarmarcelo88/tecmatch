...
*/
	...
	$lang['ADDCONTACT_1/2'] = "Contact added! To talk to him write his name follow by a colon and your message (E.g. ";
	$lang['ADDCONTACT_2/2'] = ":MESAJE)";
    $lang['CHANGESEX_GAY_MALE'] = array ("The rules have changed 😱 Now you can see gay men and they can see you");
    $lang['CHANGESEX_HETERO_MALE'] = array ("Chill, I would let you know when a girl contacts you 👌 ", "Now is time to wait... 😉 ");
    $lang['CHANGESEX_GAY_FEMALE'] = array ("Rules have changed 😱 Now you see lesbians and they can see you");
    ...
    $lang['NOCONTACTS'] = array ("That contact does not exist");
    ...
    $lang['CONTACTS'] = array ("To talk with someone write their name followed by a colon and the message you want to send (E.g. NAME:MESSAGE)", "Load more", "At this moment you don't have contacts, we will tell you when someone adds you 😉", "Click here to see profile");
    $lang['ASK_PLAY_ADD'] = array ("Add contact", "Keep playing");
    $lang['CONTACT_USER'] = array ("Hey ","! ", " added you as a contact! She made the first step, now is your turn! 😏 To talk write the name followed by a colon and the message you want to send (E.g. ",":MESSAGE)","Hey ","! "," added you. You should say hello 😉. To talk write the name followed by a colon and the message you want to send (E.g. ",":MESSAGE)", "Hey handsome, someone likes you! ✌ "," added you as a contact. To talk write the name followed by a colon and the message you want to send (E.g. ",":MESSAGE)");
    $lang['CHANGE_CHANNEL'] = array ("To which channel do you want to change: ");
    $lang['NEWGAME'] = array ("Click here to go to the profile ", "Winner","Which one do you prefer?? 😏", "Family dinner, who would you take: ", "With whom would you go out on a date?? 😜", "Who is more handsome?? 😍", "Who do you like more??", "Who would pass the filter of your friends?? 😳","At this moment, there is no one in the channel ",", try again later");
    $lang['NEWGAME_bio'] = array ("something serious", "something casual", "friends", "something fun","go to clubs", "go to the movies", "be with family", "do exercise", "watch netflix", "read","smokes 🚬", "does not smoke🚭"," is looking for ",", what he likes to do during the weekend is "," and ");
...
//super cron job
    ...
    $lang['CRON_MATCHINTERVIEWS'] = array ("Click here to go to the profile ", "Winner", "Look ", ", we found two people with similar interests. Which one do you choose? 😏");
    $lang['CRON_NEWCHANNEL'] = array (", I recommend you to change the channel sometimes to have a better result ✌");
    $lang['CRON_NEWPEOPLE'] = array ("Hey ", ", there are more people in the game! Let's play 😃");
    $lang['CRON_SCOREMSG'] = array ("You beat more people! 👊 Check your score 🎉");
    $lang['CRON_RECOMMENDCONTACT'] = array ("Hey ","! You should talk to ","! 😏 I have a good feeling about you two! 🤖 To talk write the name followed by a colon and the message you want to send (E.g. ",":MESSAGE)");
